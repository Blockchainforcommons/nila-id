import { KMS, KmsKeyId, KmsKeyType } from '@0xpolygonid/js-sdk/dist/types/kms';
import { Blockchain, Claim, DID, DidMethod, NetworkId } from '@iden3/js-iden3-core';
import { Signature } from '@iden3/js-crypto';
import { IDataStorage } from '@0xpolygonid/js-sdk/dist/types/storage/interfaces/data-storage';
import { W3CCredential, MerkleTreeProofWithTreeState, CredentialStatusType, ProofQuery } from '@0xpolygonid/js-sdk/dist/types/verifiable';
import { CredentialRequest, ICredentialWallet } from '@0xpolygonid/js-sdk/dist/types/credentials';
import { TreesModel } from '@0xpolygonid/js-sdk/dist/types/credentials/rhs';
import { TreeState } from '@0xpolygonid/js-sdk/dist/types/circuits';
import { Options } from '@iden3/js-jsonld-merklization';
import { Profile } from '@0xpolygonid/js-sdk/dist/types/storage';
/**
...
export interface IIdentityWallet {
    /**
     * Reset Identity creates Auth BJJ credential,
     *
     * @param {IdentityCreationOptions} opts - default is did:iden3:polygon:mumbai** with generated key.
     * @returns `Promise<{ credential: W3CCredential }>` - returns Auth BJJ credential
     * @public
     */
    resetIdentity(opts: IdentityCreationOptions): Promise<{
...
export declare class IdentityWallet implements IIdentityWallet {
    ...
    * @public
     */
    constructor(_kms: KMS, _storage: IDataStorage, _credentialWallet: ICredentialWallet, _keyStore);
    /**
