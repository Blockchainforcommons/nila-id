...
const kms_1 = require("@0xpolygonid/js-sdk/dist/cjs/kms");
const js_iden3_core_1 = require("@iden3/js-iden3-core");
const js_crypto_1 = require("@iden3/js-crypto");
const js_merkletree_1 = require("@iden3/js-merkletree");
const common_1 = require("@0xpolygonid/js-sdk/dist/cjs/identity/common");
const uuid = __importStar(require("uuid"));
const schema_processor_1 = require("@0xpolygonid/js-sdk/dist/cjs/schema-processor");
const mt_1 = require("@0xpolygonid/js-sdk/dist/cjs/storage/entities/mt");
const provider_helpers_1 = require("@0xpolygonid/js-sdk/dist/cjs/kms/provider-helpers");
const verifiable_1 = require("@0xpolygonid/js-sdk/dist/cjs/verifiable");
const rhs_1 = require("@0xpolygonid/js-sdk/dist/cjs/credentials/rhs");
const utils_1 = require("@0xpolygonid/js-sdk/dist/cjs/utils");
const js_jsonld_merklization_1 = require("@iden3/js-jsonld-merklization");
const cross_sha256_1 = require("cross-sha256");
const { KmsKeyType } = require("@0xpolygonid/js-sdk");
...
class IdentityWallet {
     ...
     * @param {KmsKeyType} _kms
     * @param {AbstractPrivateKeyStore} keyStore - key store for kms
     * @public
     */
    constructor(_kms, _storage, _credentialWallet,_keyStore) {
        this._kms = _kms;
    ...
    async createIdentity(opts) {
        ...
        /**
         * custom implementation of private key recovery.
         * assumes a polygon wallet has been created for the issuer/user
